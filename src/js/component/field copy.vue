  ...
  >
    ...
    >
      ...
      <template v-if="['nohtml'].includes(field.type)">
        <div
          v-show="field.html || field.message || field.text1 || field.nohtml"
          v-text="field.html || field.message || field.text2 || field.nohtml"
        ></div>
      </template>
      ...
      <template v-if="['html'].includes(field.type)">
        <div
          v-show="field.html || field.message || field.text3"
          v-html="field.html || field.message || field.text4"
        ></div>
      </template>
